...
async function getAIResponse(question) {
    ...
    const GROQ_API_KEY = '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';
    ...
    return {
        ...
        sources: ['📖 Offline Mode - Add Groq API key for full AI']
    };
}
